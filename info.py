...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002316140068'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5552521515').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002468000321').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5552521515').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001980205368') # give your force subscribe channel id here else leave it blank
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ramparshadbismillah:<db_password>@cluster0.xkwhj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # IF Multiple Database Is False Then Fill Only This Database Url.
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Link_12')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Elite_Support_Chat') # Support Chat Link Without https:// or @
