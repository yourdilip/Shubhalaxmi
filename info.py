...
API_ID = int(environ.get('API_ID', '24437615'))
API_HASH = environ.get('API_HASH', '67ef9e0a9668ddb85ccfac854c5285db')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002375485223'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1655553561').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://arivazhaganprathap:9342240083cz@cluster3.kltq0.mongodb.net/?retryWrites=true&w=majority&appName=Cluster3")
